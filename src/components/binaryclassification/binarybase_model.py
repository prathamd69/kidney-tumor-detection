...
logger = configLogger("binarybase_model", "binarybase_model.log")
...
def main():
    ...
    binary_lr = float(params.binaryclass_model_params.learning_rate)
    binaryloss = str(params.binaryclass_model_params.loss)
    ...
    opt_name = params.binaryclass_model_params.optimizer
