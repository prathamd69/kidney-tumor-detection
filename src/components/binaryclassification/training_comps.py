...
def training(config: ConfigBox, params: ConfigBox) -> Tuple[tf.data.Dataset, tf.data.Dataset, tf.keras.Model]:
    ...
    model = build_base_model(
        img_shape=img_shape,
        lr=params.binaryclass_model_params.learning_rate,
        loss=params.binaryclass_model_params.loss,
        metrics=params.binaryclass_model_params.metrics,
        optimizer=params.binaryclass_model_params.optimizer,
        is_binaryClassification=params.binaryclass_model_params.is_binaryClassification,
        num_classes=params.binaryclass_model_params.num_classes
    )
